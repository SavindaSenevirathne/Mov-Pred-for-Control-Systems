...
class extractEmbeddings:
    ...
    def embedding():
        ...
        embedder = cv2.dnn.readNetFromTorch(
            "opencvFaceRecognition/openface_nn4.small2.v1.t7")

        # grab the paths to the input images in our dataset
        print("[INFO] quantifying faces...")
        imagePaths = list(paths.list_images("opencvFaceRecognition/dataset"))
        ...
        f = open("opencvFaceRecognition/output/embeddings.pickle", "wb")
